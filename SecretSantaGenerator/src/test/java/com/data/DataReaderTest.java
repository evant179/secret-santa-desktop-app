...
public class DataReaderTest
{
    ...
    public void testDataReader()
    {
        ...
        assertThat(secretSantaList, hasItem(new SecretSanta(TESTNAME5, new ArrayList<String>())));
        assertThat(secretSantaList, hasItem(new SecretSanta(TESTNAME6, new ArrayList<String>())));
        assertThat(secretSantaList, hasItem(new SecretSanta(TESTNAME7, new ArrayList<String>())));
        assertThat(secretSantaList, hasItem(new SecretSanta(TESTNAME8, new ArrayList<String>())));
        assertThat(secretSantaList, hasItem(new SecretSanta(TESTNAME9, new ArrayList<String>())));
        assertThat(secretSantaList, hasItem(new SecretSanta(TESTNAME10, new ArrayList<String>())));
